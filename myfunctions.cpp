...
// void matrixMultiply(float*matrix_1, float*matrix_2, float*product, int n)
// {
...
// void matrixRead(string path, float *arr, int columns, int rows, bool semiRead, int columnRead)
// {
//     if (semiRead == false)
//         columnRead = columns;
...
// void matrixSum(float *matrix_1, float *matrix_2, float *sum, int n)
// {
//     for(int i=0; i<n; i++)
//         for(int j=0; j<n; j++)
//         {
...
// void matrixSetIdentity(float *matrix, int n, bool semiFill, int totalColumns)
// {
//     if(semiFill == false)
//         totalColumns = n;
...
// // void substitution(float *L, float*U, float *B, float *X, int n, bool XColumn)
// // {
// //     int fillX;
// //     if(XColumn == true)
// //         fillX = n;
